...
@section('header', 'Yeni Model Ekle')
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        <div class="p-8">
            <h3 class="text-xl font-bold text-slate-800 mb-6">Model Kayıt Formu</h3>
            <form action="{{ route('admin.motorcycle-models.store') }}" method="POST">
                @csrf
                <div class="space-y-4">
                    <div>
                    <div>
